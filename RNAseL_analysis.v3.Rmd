...
# Load data
```{r Loading data}
all <- read.delim2("read_counts_exonic.txt", sep = "\t", header = TRUE, row.names = 1, comment.char = c("#"))
...
for (i in names(DE_results)){
  ...
  run_enrichment_analysis(gene_set = msig_h, geneList = geneList, analysis_name = my_prefix, gs_name = "H", type = "general")
  ...
  # Run Gene Set Enrichment Analysis
  run_enrichment_analysis(gene_set = msig_c3_gtrd, geneList = geneList, analysis_name = my_prefix, gs_name = "C3_TFT_GTRD", type = "general")
  run_enrichment_analysis(gene_set = msig_c3_tft, geneList = geneList, analysis_name = my_prefix, gs_name = "C3_TFT_Legacy", type = "general")
